...
function Index() {
  return __jsx("div", {
    ...
    __self: this
  }, "free to attend"), " with a \"pay-what-you-can\" donation model. The goal is to stick to traditional FOSS values and fund this event by and for the community Because of Gitcoin Grants and Quadratic matching, even 1 DAI could go a long way (in some cases, up to 300 DAI in support from the matching funds).  Would you mind supporting the event? Click here: https://gitcoin.co/grants/195/sustain-web3-sustainers "), __jsx("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    },
...
//# sourceMappingURL=index.js.22f65a9aa6d803f17d4d.hot-update.js.map